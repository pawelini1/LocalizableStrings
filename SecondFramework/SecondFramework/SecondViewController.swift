...
public class SecondViewController: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        titleLabel.text = "SecondViewController.title.text".localized()
        descriptionLabel.text = "SecondViewController.description.text".localized()
    }
}

extension String {
    func localized(with comment: String = "") -> String {
        let mainBundleKey = "SecondFramework.\(self)"
        ...
        let frameworkBundle = Bundle(for: SecondViewController.self)
